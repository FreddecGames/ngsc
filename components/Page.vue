<script setup>
    ...
    const getTimeSinceStartDate = computed(() => { return (new Date().getTime() - store.statsStartDate) / 1000 })
    
    const newCompanyName = store.companyName
    
    const exported = computed(() => localStorage.getItem('ngsc'))
    
    const autoDysonUnlocked = computed(() => { return store.getItemCount('ulUpgdAutoDyson') >= 1 })
    
    const dysonT1 = computed(() => { return store.getItem('dysonT1') })
    const dysonT2 = computed(() => { return store.getItem('dysonT2') })
    
    const rebirthCosts = computed(() => { return store.getBuildCosts('rebirth', 1) })
    const canRebirth = computed(() => canBuild('rebirth', 1))
    
    const enlightenCosts = computed(() => { return store.getBuildCosts('enlighten', 1) })
    const canEnlighten = computed(() => canBuild('enlighten', 1))
    
    const confirmReset = ref(false)
    const confirmRebirth = ref(false)
    const confirmEnlighten = ref(false)
    ...
    const importData = function() {
        ...
        if (!imported.value || !imported.value.trim()) {
            
            store.showToast('toastImportEmpty')
            return console.warn('No data to import')
        }
        
        if (imported.value.length % 4 !== 0) {
            
            store.showToast('toastImportCorrupted')
            return console.warn('Data corrupted')
        }
        
        store.resetInProgress = true
        
        localStorage.setItem('ngsc', imported.value)
...
<template>
    <div id="page">
        <div class="tab-content">
                    ...
                    <template v-slot:col-2>
                        <div class="col">
                            <div class="row g-2 row-cols-1">
                                ...
                                <form class="d-flex justify-content-end" action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_blank">
                                    ...
                                    <button type="submit" class="btn btn-primary justify-content-center" style="width: 95px">
                                        <div class="row gx-2 align-items-center">
                                            <div class="col-auto d-flex align-items-center"><img src="/icons/paypal.png" width="16" height="16" /></div>
                        ...
                        <div class="col">
                            <div class="row g-1 row-cols-1">
                                ...
                                <div class="d-flex justify-content-end">
                                    <a href="https://www.patreon.com/bePatron?u=61283131" class="btn btn-primary justify-content-center" style="width: 95px" target="_blank">
                                        <div class="row gx-2 align-items-center">
                                            <div class="col-auto d-flex align-items-center"><img src="/icons/patreon.png" width="16" height="16" /></div>
                        ...
                        <div class="col">
                            <div class="row g-1 row-cols-1">
                                ...
                                <div class="d-flex justify-content-end">
                                    <a href="https://ko-fi.com/freddecgames" class="btn btn-primary justify-content-center" style="width: 95px" target="_blank">
                                        <div class="row gx-2 align-items-center">
                                            <div class="col-auto d-flex align-items-center"><img src="/icons/kofi.png" width="16" height="16" /></div>
            ...
            <page-pane id="statsPane" name="menu-item-stats" icon="\icons\stats.png">
                <card id="statsCard" name="statsCardTitle" body="true">
                    <template v-slot:body>
                        <div class="col">
                            <div class="row g-2">
                                <div class="col-6">
                                    <div class="small mb-1">{{ $t('statsStartDate') }}</div>
                                    <div class="text-light lh-1"><format-time :time="getTimeSinceStartDate" /></div>
                                </div>
                                <div class="col-6">
                                    <div class="small mb-1">{{ $t('statsTotal') }}</div>
                                    <div class="text-light lh-1">
                                        <div class="row g-0 align-items-center">
                                            <div class="col-auto"><img class="me-1" src="/icons/conquest.png" width="16" height="16" :alt="$t('statue')" /></div>
                                            <div class="col-auto"><span class="text-light me-3">{{ statsTotalConquests }}</span></div>
                                            <div class="col-auto"><img class="me-1" src="/icons/statue.png" width="16" height="16" :alt="$t('statue')" /></div>
                                            <div class="col-auto"><span class="text-light">{{ statsTotalStatues }}</span></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="small mb-1">{{ $t('statsLastRebirth') }}</div>
                                    <div v-if="statsTotalRebirths > 0" class="text-light lh-1"><format-time :time="getTimeSinceLastRebirth" /></div>
                                    <div v-if="statsTotalRebirths <= 0" class="text-normal">---</div>
                                </div>
                                <div class="col-6">
                                    <div class="small mb-1">{{ $t('statsTotalRebirths') }}</div>
                                    <div class="text-light lh-1">{{ statsTotalRebirths }}</div>
                                </div>
                                <div class="col-6">
                                    <div class="small mb-1">{{ $t('statsLastEnlighten') }}</div>
                                    <div v-if="statsTotalEnlightens > 0" class="text-light lh-1"><format-time :time="getTimeSinceLastEnlighten" /></div>
                                    <div v-if="statsTotalEnlightens <= 0" class="text-normal">---</div>
                                </div>
                                <div class="col-6">
                                    <div class="small mb-1">{{ $t('statsTotalEnlightens') }}</div>
                                    <div class="text-light lh-1">{{ statsTotalEnlightens }}</div>
                                </div>
                            </div>
                        </div>
                    </template>
            ...
            <page-pane id="optionsPane" name="menu-item-options" icon="\icons\options.png">
                ...
                <card id="languageCard" name="languageCardTitle" body="true">
                    <template v-slot:body>
                        <div class="col">
                            <div class="row g-2">
                                <div v-for="l in locales" :key="l.code" class="col-auto">
                                    <button class="btn btn-primary py-1" :class="{ 'active':l.code == locale }" @click="changeLocale(l.code)"><img :src="'/languages/' + l.code + '.png'" width="32" height="32" /></button>
                                </div>
                            </div>
                        </div>
                    </template>
                    ...
                    <template v-slot:body>
                        <div class="col">
                            <div class="row g-2 row-cols-1">
                                ...
                                <div class="col">
                                    <textarea class="form-control" disabled style="height:100px;" v-model="exported"></textarea>
                                </div>
                                <div class="col">
                                    <div class="row g-2 justify-content-end">                                    
                                        <div class="col-auto">
                                            <button class="btn btn-primary" @click="exportSave()">{{ $t('button-export') }}</button>
                                        </div>
                                        <div class="col-auto">
                                            <button class="btn btn-primary" @click="downloadSave()">{{ $t('button-download') }}</button>
                                        </div>
                                    </div>
                                </div>
                                <div class="col">
                                    <textarea class="form-control" style="height:100px;" v-model="imported"></textarea>
                                </div>
                                <div class="col">
                                    <div class="row g-2 align-items-center">
                                        <div v-if="!confirmReset" class="col-auto">
                                        ...
                                        <div v-if="confirmReset" class="col small">
            ...
            <page-pane id="aboutPane" name="menu-item-about" icon="\icons\about.png">
                <card id="infoCard" name="infoCardTitle" body="true">
                    <template v-slot:header>
                        <div class="col-auto small text-light">{{ gameVersion }}</div>
                        <div class="col-auto small"><a href="/?page=privacy" target="_blank">Privacy policy</a></div>
                    </template>
                    <template v-slot:body>
                        <div class="col">
                            <div class="row g-2 row-cols-1">
                                <div class="col small"><span>{{ $t('infoCardText1') }}</span></div>
                                <div class="col small">
                                    <span class="me-2">{{ $t('infoCardText2') }}</span>
                                    <a href="https://sparticle999.github.io/SpaceCompany/" target="_blank">https://sparticle999.github.io/SpaceCompany/</a>
                                </div>
                                <div class="col small"><span class="text-light">{{ $t('infoCardText3') }}</span></div>
                                <div class="col small"><span class="text-light">{{ $t('infoCardText4') }}</span></div>
                            </div>
                        </div>
                        <div class="col">
                            <div class="row g-2 justify-content-end">
                                ...
                                <div class="col-auto">
                                    <button type="button" class="btn btn-primary" @click="setActivePane('donatingPane');">
                                        <img src="/icons/donating.png" width="16" height="16" :alt="$t('menu-item-donating')" />
            ...
            <page-pane id="earthPane" name="sidebar-item-earth" icon="\icons\earth.png">
            ...
            <page-pane id="rocketPane" name="sidebar-item-rocket" icon="\icons\rocket.png">
            ...
            <page-pane id="innerSolarSystemPane" name="sidebar-item-innerSolarSystem" icon="\icons\innerSolarSystem.png">
            ...
            <page-pane id="outerSolarSystemPane" name="sidebar-item-outerSolarSystem" icon="\icons\outerSolarSystem.png">
            ...
            <page-pane id="wonderStation1Pane" name="sidebar-item-wonderStation1" icon="\icons\wonderStation.png">
            ...
            <page-pane id="alienTechnologiesPane" name="sidebar-item-alienTechnologies" icon="\icons\alien.png">
            ...
            <page-pane id="rebirthPane" name="sidebar-item-rebirth" icon="\icons\rebirth.png">
            ...
            <page-pane id="wonderStation2Pane" name="sidebar-item-wonderStation2" icon="\icons\wonderStation.png">
            ...
            <page-pane id="spaceshipPane" name="sidebar-item-spaceship" icon="\icons\spaceship.png">
                ...
                <card-building id="missionShieldCard" name="missionShield" :descs="[ 'missionShield-desc1' ]" icon="\icons\shield.png" itemId="missionShield" btnText="button-build" />
                <card-building id="missionEngineCard" name="missionEngine" :descs="[ 'missionEngine-desc1' ]" icon="\icons\engine.png" itemId="missionEngine" btnText="button-build" />
                <card-building id="missionAeroCard" name="missionAero" :descs="[ 'missionAero-desc1' ]" icon="\icons\aero.png" itemId="missionAero" btnText="button-build" />
            </page-pane>
            
            <page-pane id="enlightenmentPane" name="sidebar-item-enlightenment" icon="\icons\enlightenment.png">
            ...
            <page-pane id="overlordPane" name="sidebar-item-overlord" icon="\icons\overlord.png">
                    ...
                    <template v-slot:col-2>
                        ...
                        <div class="col-6">
                            <div class="d-flex align-items-center">
                                <img class="me-1" src="/icons/statue.png" width="14" height="14" :alt="$t('statue')" />
                                <small>150</small>
                            </div>
                            <line-progress itemId="statue" target="150" />
            ...
            <page-pane-resource id="energyPane" name="energy" icon="\icons\energy.png" itemId="energy">
            ...
            <page-pane-resource id="plasmaPane" name="plasma" icon="\icons\plasma.png" itemId="plasma">
            ...
            <page-pane-resource id="meteoritePane" name="meteorite" icon="\icons\meteorite.png" itemId="meteorite">
            ...
            <page-pane-resource id="carbonPane" name="carbon" icon="\icons\carbon.png" itemId="carbon">
            ...
            <page-pane-resource id="sciencePane" name="science" icon="\icons\science.png" itemId="science">
            ...
            <page-pane-resource id="oilPane" name="oil" icon="\icons\oil.png" itemId="oil">
            ...
            <page-pane-resource id="fuelPane" name="fuel" icon="\icons\fuel.png" itemId="fuel">
            ...
            <page-pane-resource id="metalPane" name="metal" icon="\icons\metal.png" itemId="metal">
            ...
            <page-pane-resource id="gemPane" name="gem" icon="\icons\gem.png" itemId="gem">
            ...
            <page-pane-resource id="woodPane" name="wood" icon="\icons\wood.png" itemId="wood">
            ...
            <page-pane-resource id="siliconPane" name="silicon" icon="\icons\silicon.png" itemId="silicon">
            ...
            <page-pane-resource id="uraniumPane" name="uranium" icon="\icons\uranium.png" itemId="uranium">
            ...
            <page-pane-resource id="lavaPane" name="lava" icon="\icons\lava.png" itemId="lava">
            ...
            <page-pane-resource id="lunaritePane" name="lunarite" icon="\icons\lunarite.png" itemId="lunarite">
            ...
            <page-pane-resource id="methanePane" name="methane" icon="\icons\methane.png" itemId="methane">
            ...
            <page-pane-resource id="titaniumPane" name="titanium" icon="\icons\titanium.png" itemId="titanium">
            ...
            <page-pane-resource id="goldPane" name="gold" icon="\icons\gold.png" itemId="gold">
            ...
            <page-pane-resource id="silverPane" name="silver" icon="\icons\silver.png" itemId="silver">
            ...
            <page-pane-resource id="hydrogenPane" name="hydrogen" icon="\icons\hydrogen.png" itemId="hydrogen">
            ...
            <page-pane-resource id="heliumPane" name="helium" icon="\icons\helium.png" itemId="helium">
            ...
            <page-pane-resource id="icePane" name="ice" icon="\icons\ice.png" itemId="ice">
            ...
            <page-pane-resource id="antimatterPane" name="antimatter" icon="\icons\antimatter.png" itemId="antimatter">
                <card-upgrade id="antimatterUpgradeCard" :descs="[ 'antimatterUpgrade-desc1' ]" itemId="antimatter" />
            ...
            <page-pane id="productionPane" name="sidebar-item-consumption" icon="\icons\production.png">
                <card-production id="energyProdCard" name="energy" icon="\icons\energy.png" itemId="energy">
                ...
                <card-production id="plasmaProdCard" name="plasma" icon="\icons\plasma.png" itemId="plasma">
                    <template v-slot:consumers>
                ...
                <card-production id="meteoriteProdCard" name="meteorite" icon="\icons\meteorite.png" itemId="meteorite">
                    <template v-slot:consumers>
                    </template>
                    <template v-slot:producers>
                ...
                <card-production id="carbonProdCard" name="carbon" icon="\icons\carbon.png" itemId="carbon">
                    <template v-slot:consumers>
                ...
                <card-production id="fuelProdCard" name="fuel" icon="\icons\fuel.png" itemId="fuel">
                    <template v-slot:consumers>
                    </template>
                    <template v-slot:producers>
                ...
                <card-production id="antimatterProdCard" name="antimatter" icon="\icons\antimatter.png" itemId="antimatter">
                    <template v-slot:consumers>
                    </template>
                    <template v-slot:producers>
                ...
                <card-production id="scienceProdCard" name="science" icon="\icons\science.png" itemId="science">
                    <template v-slot:consumers>
                    </template>
                    <template v-slot:producers>
                ...
                <card-production id="oilProdCard" name="oil" icon="\icons\oil.png" itemId="oil">
                    <template v-slot:consumers>
                ...
                <card-production id="metalProdCard" name="metal" icon="\icons\metal.png" itemId="metal">
                    <template v-slot:consumers>
                    </template>
                    <template v-slot:producers>
                ...
                <card-production id="gemProdCard" name="gem" icon="\icons\gem.png" itemId="gem">
                    <template v-slot:consumers>
                    </template>
                    <template v-slot:producers>
                ...
                <card-production id="woodProdCard" name="wood" icon="\icons\wood.png" itemId="wood">
                    <template v-slot:consumers>
                ...
                <card-production id="siliconProdCard" name="silicon" icon="\icons\silicon.png" itemId="silicon">
                    <template v-slot:consumers>
                    </template>
                    <template v-slot:producers>
                ...
                <card-production id="uraniumProdCard" name="uranium" icon="\icons\uranium.png" itemId="uranium">
                    <template v-slot:consumers>
                ...
                <card-production id="lavaProdCard" name="lava" icon="\icons\lava.png" itemId="lava">
                    <template v-slot:consumers>
                ...
                <card-production id="lunariteProdCard" name="lunarite" icon="\icons\lunarite.png" itemId="lunarite">
                    <template v-slot:consumers>
                    </template>
                    <template v-slot:producers>
                ...
                <card-production id="methaneProdCard" name="methane" icon="\icons\methane.png" itemId="methane">
                    <template v-slot:consumers>
                ...
                <card-production id="titaniumProdCard" name="titanium" icon="\icons\titanium.png" itemId="titanium">
                    <template v-slot:consumers>
                    </template>
                    <template v-slot:producers>
                ...
                <card-production id="goldProdCard" name="gold" icon="\icons\gold.png" itemId="gold">
                    <template v-slot:consumers>
                    </template>
                    <template v-slot:producers>
                ...
                <card-production id="silverProdCard" name="silver" icon="\icons\silver.png" itemId="silver">
                    <template v-slot:consumers>
                    </template>
                    <template v-slot:producers>
                ...
                <card-production id="hydrogenProdCard" name="hydrogen" icon="\icons\hydrogen.png" itemId="hydrogen">
                    <template v-slot:consumers>
                ...
                <card-production id="heliumProdCard" name="helium" icon="\icons\helium.png" itemId="helium">
                    <template v-slot:consumers>
                        <line-consumption resId="helium" itemId="energyT6" level="T6" res="energy" />
                        <line-consumption resId="helium" itemId="plasmaT2" level="T2" res="plasma" />
                        <line-consumption resId="helium" itemId="plasmaT3" level="T3" res="plasma" />
                        <line-consumption resId="helium" itemId="plasmaT4" level="T4" res="plasma" />
                    </template>
                    <template v-slot:producers>
                ...
                <card-production id="iceProdCard" name="ice" icon="\icons\ice.png" itemId="ice">
                    <template v-slot:consumers>
            ...
            <page-pane id="achievementsPane" name="sidebar-item-achievements" icon="\icons\achievements.png">
                <card-achievement name="energy" icon="\icons\energy.png" unlockerId="energy" :achs="['achEnergy', 'achEnergyT1', 'achEnergyT2', 'achEnergyT3', 'achEnergyT4', 'achEnergyT5', 'achEnergyT6']">
                    <line-ach icon="\icons\true" itemId="achEnergy" />
                ...
                <card-achievement name="plasma" icon="\icons\plasma.png" unlockerId="plasma" :achs="['achPlasma', 'achPlasmaT1', 'achPlasmaT2', 'achPlasmaT3', 'achPlasmaT4']">
                    <line-ach icon="\icons\true" itemId="achPlasma" />
                ...
                <card-achievement name="meteorite" icon="\icons\meteorite.png" unlockerId="meteorite" :achs="['achMeteorite', 'achMeteoriteT1', 'achMeteoriteT2', 'achMeteoriteT3', 'achMeteoriteT4']">
                    <line-ach icon="\icons\true" itemId="achMeteorite" />
                ...
                <card-achievement name="carbon" icon="\icons\carbon.png" unlockerId="carbon" :achs="['achCarbon', 'achCarbonT1', 'achCarbonT2', 'achCarbonT3', 'achCarbonT4', 'achCarbonT5']">
                    <line-ach icon="\icons\true" itemId="achCarbon" />
                ...
                <card-achievement name="science" icon="\icons\science.png" unlockerId="science" :achs="['achScience', 'achScienceT1', 'achScienceT2', 'achScienceT3', 'achScienceT4', 'achScienceT5']">
                    <line-ach icon="\icons\true" itemId="achScience" />
                ...
                <card-achievement name="oil" icon="\icons\oil.png" unlockerId="oil" :achs="['achOil', 'achOilT1', 'achOilT2', 'achOilT3', 'achOilT4', 'achOilT5']">
                    <line-ach icon="\icons\true" itemId="achOil" />
                ...
                <card-achievement name="fuel" icon="\icons\fuel.png" unlockerId="fuel" :achs="['achFuel', 'achFuelT1', 'achFuelT2', 'achFuelT3']">
                    <line-ach icon="\icons\true" itemId="achFuel" />
                    <line-ach name="T1" itemId="achFuelT1" />
                    <line-ach name="T2" itemId="achFuelT2" />
                    <line-ach name="T3" itemId="achFuelT3" />
                </card-achievement>
                <card-achievement name="metal" icon="\icons\metal.png" unlockerId="metal" :achs="['achMetal', 'achMetalT1', 'achMetalT2', 'achMetalT3', 'achMetalT4', 'achMetalT5']">
                    <line-ach icon="\icons\true" itemId="achMetal" />
                ...
                <card-achievement name="gem" icon="\icons\gem.png" unlockerId="gem" :achs="['achGem', 'achGemT1', 'achGemT2', 'achGemT3', 'achGemT4', 'achGemT5']">
                    <line-ach icon="\icons\true" itemId="achGem" />
                ...
                <card-achievement name="wood" icon="\icons\wood.png" unlockerId="wood" :achs="['achWood', 'achWoodT1', 'achWoodT2', 'achWoodT3', 'achWoodT4', 'achWoodT5']">
                    <line-ach icon="\icons\true" itemId="achWood" />
                ...
                <card-achievement name="silicon" icon="\icons\silicon.png" unlockerId="silicon" :achs="['achSilicon', 'achSiliconT1', 'achSiliconT2', 'achSiliconT3', 'achSiliconT4', 'achSiliconT5']">
                    <line-ach icon="\icons\true" itemId="achSilicon" />
                ...
                <card-achievement name="uranium" icon="\icons\uranium.png" unlockerId="uranium" :achs="['achUranium', 'achUraniumT1', 'achUraniumT2', 'achUraniumT3', 'achUraniumT4', 'achUraniumT5']">
                    <line-ach icon="\icons\true" itemId="achUranium" />
                ...
                <card-achievement name="lava" icon="\icons\lava.png" unlockerId="lava" :achs="['achLava', 'achLavaT1', 'achLavaT2', 'achLavaT3', 'achLavaT4', 'achLavaT5']">
                    <line-ach icon="\icons\true" itemId="achLava" />
                ...
                <card-achievement name="lunarite" icon="\icons\lunarite.png" unlockerId="lunarite" :achs="['achLunarite', 'achLunariteT1', 'achLunariteT2', 'achLunariteT3', 'achLunariteT4', 'achLunariteT5']">
                    <line-ach icon="\icons\true" itemId="achLunarite" />
                ...
                <card-achievement name="methane" icon="\icons\methane.png" unlockerId="methane" :achs="['achMethane', 'achMethaneT1', 'achMethaneT2', 'achMethaneT3', 'achMethaneT4', 'achMethaneT5']">
                    <line-ach icon="\icons\true" itemId="achMethane" />
                ...
                <card-achievement name="titanium" icon="\icons\titanium.png" unlockerId="titanium" :achs="['achTitanium', 'achTitaniumT1', 'achTitaniumT2', 'achTitaniumT3', 'achTitaniumT4', 'achTitaniumT5']">
                    <line-ach icon="\icons\true" itemId="achTitanium" />
                ...
                <card-achievement name="gold" icon="\icons\gold.png" unlockerId="gold" :achs="['achGold', 'achGoldT1', 'achGoldT2', 'achGoldT3', 'achGoldT4', 'achGoldT5']">
                    <line-ach icon="\icons\true" itemId="achGold" />
                ...
                <card-achievement name="silver" icon="\icons\silver.png" unlockerId="silver" :achs="['achSilver', 'achSilverT1', 'achSilverT2', 'achSilverT3', 'achSilverT4', 'achSilverT5']">
                    <line-ach icon="\icons\true" itemId="achSilver" />
                ...
                <card-achievement name="hydrogen" icon="\icons\hydrogen.png" unlockerId="hydrogen" :achs="['achHydrogen', 'achHydrogenT1', 'achHydrogenT2', 'achHydrogenT3', 'achHydrogenT4', 'achHydrogenT5']">
                    <line-ach icon="\icons\true" itemId="achHydrogen" />
                ...
                <card-achievement name="helium" icon="\icons\helium.png" unlockerId="helium" :achs="['achHelium', 'achHeliumT1', 'achHeliumT2', 'achHeliumT3', 'achHeliumT4', 'achHeliumT5']">
                    <line-ach icon="\icons\true" itemId="achHelium" />
                ...
                <card-achievement name="ice" icon="\icons\ice.png" unlockerId="ice" :achs="['achIce', 'achIceT1', 'achIceT2', 'achIceT3', 'achIceT4', 'achIceT5']">
                    <line-ach icon="\icons\true" itemId="achIce" />
                ...
                <card-achievement name="antimatter" icon="\icons\antimatter.png" unlockerId="antimatter" :achs="['achAntimatter', 'achAntimatterT1']">
                    <line-ach icon="\icons\true" itemId="achAntimatter" />
                    <line-ach name="T1" itemId="achAntimatterT1" />
                </card-achievement>
            </page-pane>
            
            <page-pane id="technologiesPane" name="sidebar-item-technologies" icon="\icons\technologies.png">
                <template v-slot:titleBar>
                    <div class="col-auto">
                        <div class="card">
                            <div class="card-body small text-end p-2 border-0 d-flex">
                                <div class="col-auto d-flex align-items-center pe-2">
                                    <img src="/icons/science.png" width="14" height="14" :alt="$t('science')" />
                                </div>
                                <div class="col-auto">
                ...
                <card id="scienceBoostsCard" name="scienceBoostsCardTitle" body="true">
                    <template v-slot:header>
                        <line-science-boost-count />
                        <div class="col-12 small">{{ $t('scienceBoost_desc') }}</div>
                    </template>
                    <template v-slot:body>
                        <div class="col">
                            <div class="row row-cols-1 g-2">
                                <line-science-boost itemId="scienceBoostEnergy" icon="\icons\energy.png" name="energy" />
                                <line-science-boost itemId="scienceBoostPlasma" icon="\icons\plasma.png" name="plasma" />
                                <line-science-boost itemId="scienceBoostMeteorite" icon="\icons\meteorite.png" name="meteorite" />
                                <line-science-boost itemId="scienceBoostCarbon" icon="\icons\carbon.png" name="carbon" />
                                <line-science-boost itemId="scienceBoostFuel" icon="\icons\fuel.png" name="fuel" />
                                <line-science-boost itemId="scienceBoostScience" icon="\icons\science.png" name="science" />
                                <line-science-boost itemId="scienceBoostOil" icon="\icons\oil.png" name="oil" />
                                <line-science-boost itemId="scienceBoostMetal" icon="\icons\metal.png" name="metal" />
                                <line-science-boost itemId="scienceBoostGem" icon="\icons\gem.png" name="gem" />
                                <line-science-boost itemId="scienceBoostWood" icon="\icons\wood.png" name="wood" />
                                <line-science-boost itemId="scienceBoostSilicon" icon="\icons\silicon.png" name="silicon" />
                                <line-science-boost itemId="scienceBoostUranium" icon="\icons\uranium.png" name="uranium" />
                                <line-science-boost itemId="scienceBoostLava" icon="\icons\lava.png" name="lava" />
                                <line-science-boost itemId="scienceBoostLunarite" icon="\icons\lunarite.png" name="lunarite" />
                                <line-science-boost itemId="scienceBoostMethane" icon="\icons\methane.png" name="methane" />
                                <line-science-boost itemId="scienceBoostTitanium" icon="\icons\titanium.png" name="titanium" />
                                <line-science-boost itemId="scienceBoostGold" icon="\icons\gold.png" name="gold" />
                                <line-science-boost itemId="scienceBoostSilver" icon="\icons\silver.png" name="silver" />
                                <line-science-boost itemId="scienceBoostHydrogen" icon="\icons\hydrogen.png" name="hydrogen" />
                                <line-science-boost itemId="scienceBoostHelium" icon="\icons\helium.png" name="helium" />
                                <line-science-boost itemId="scienceBoostIce" icon="\icons\ice.png" name="ice" />
                                <line-science-boost itemId="scienceBoostAntimatter" icon="\icons\antimatter.png" name="antimatter" />
                            </div>
                        </div>
                    </template>
                </card>
            ...
            <page-pane id="emcPane" name="sidebar-item-emc" icon="\icons\emc.png">
                <card-emc name="meteorite" icon="\icons\meteorite.png" itemId="meteorite" />
                <card-emc name="carbon" icon="\icons\carbon.png" itemId="carbon" />
                <card-emc name="oil" icon="\icons\oil.png" itemId="oil" />
                <card-emc name="metal" icon="\icons\metal.png" itemId="metal" />
                <card-emc name="gem" icon="\icons\gem.png" itemId="gem" />
                <card-emc name="wood" icon="\icons\wood.png" itemId="wood" />
                <card-emc name="silicon" icon="\icons\silicon.png" itemId="silicon" />
                <card-emc name="uranium" icon="\icons\uranium.png" itemId="uranium" />
                <card-emc name="lava" icon="\icons\lava.png" itemId="lava" />
                <card-emc name="lunarite" icon="\icons\lunarite.png" itemId="lunarite" />
                <card-emc name="methane" icon="\icons\methane.png" itemId="methane" />
                <card-emc name="titanium" icon="\icons\titanium.png" itemId="titanium" />
                <card-emc name="gold" icon="\icons\gold.png" itemId="gold" />
                <card-emc name="silver" icon="\icons\silver.png" itemId="silver" />
                <card-emc name="hydrogen" icon="\icons\hydrogen.png" itemId="hydrogen" />
                <card-emc name="helium" icon="\icons\helium.png" itemId="helium" />
                <card-emc name="ice" icon="\icons\ice.png" itemId="ice" />
            </page-pane>
            
            <page-pane id="radarPane" name="sidebar-item-radar" icon="\icons\radar.png">
                <template v-slot:titleBar>
                    <div class="col-auto">
                        <div class="card">
            ...
            <page-pane id="shipsPane" name="sidebar-item-ships" icon="\icons\ships.png">
                <template v-slot:titleBar>
                    <div class="col-auto">
                        <div class="card">
                            <div class="card-body small text-end p-2 border-0">
            ...
            <page-pane-faction id="carnelianPane" name="sidebar-item-carnelian" icon="\icons\carnelian.png" faction="carnelian" :descs1="[ 'carnelian-desc1' ]" :descs2="[ 'carnelian-desc2' ]">
            ...
            <page-pane-faction id="prasnianPane" name="sidebar-item-prasnian" icon="\icons\prasnian.png" faction="prasnian" :descs1="[ 'prasnian-desc1' ]" :descs2="[ 'prasnian-desc2' ]">
            ...
            <page-pane-faction id="hyacinitePane" name="sidebar-item-hyacinite" icon="\icons\hyacinite.png" faction="hyacinite" :descs1="[ 'hyacinite-desc1' ]" :descs2="[ 'hyacinite-desc2' ]">
            ...
            <page-pane-faction id="kitrinosPane" name="sidebar-item-kitrinos" icon="\icons\kitrinos.png" faction="kitrinos" :descs1="[ 'kitrinos-desc1' ]" :descs2="[ 'kitrinos-desc2' ]">
            ...
            <page-pane-faction id="movitonPane" name="sidebar-item-moviton" icon="\icons\moviton.png" faction="moviton" :descs1="[ 'moviton-desc1' ]" :descs2="[ 'moviton-desc2' ]">
            ...
            <page-pane id="dysonPane" name="sidebar-item-dyson" icon="\icons\dyson.png">
                <card-building id="segmentCard" name="segment" :descs="[ 'segment-desc1' ]" icon="\icons\segment.png" itemId="segment" btnText="button-build" />
                <card-building id="dysonT1Card" name="dysonT1" :descs="[ 'dysonT1-desc1' ]" icon="\icons\dysonT1.png" itemId="dysonT1" btnText="button-build">
                    <div class="col-auto">
                        <button-build-segment itemId="dysonT1" count="50" btnText="button-buildSegmentRing" />
                    </div>
                    <div v-if="autoDysonUnlocked" class="col-auto">
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" id="autoDyson-segmentRing" v-model="dysonT1.auto" @click="dysonT2.auto = false">
                            <label class="form-check-label small" for="autoDyson-segmentRing">{{ $t('value-automatic') }}</label>
                        </div>
                    </div>
                </card-building>
                <card-building id="dysonT2Card" name="dysonT2" :descs="[ 'dysonT2-desc1' ]" icon="\icons\dysonT2.png" itemId="dysonT2" btnText="button-build">
                    <div class="col-auto">
                        <button-build-segment itemId="dysonT2" count="100" btnText="button-buildSegmentSwarm" />
                    </div>
                    <div v-if="autoDysonUnlocked" class="col-auto">
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" id="autoDyson-segmentSwarm" v-model="dysonT2.auto" @click="dysonT1.auto = false">
                            <label class="form-check-label small" for="autoDyson-segmentSwarm">{{ $t('value-automatic') }}</label>
                        </div>
                    </div>
                </card-building>
                <card-building id="dysonT3Card" name="dysonT3" :descs="[ 'dysonT3-desc1' ]" icon="\icons\dysonT3.png" itemId="dysonT3" btnText="button-build">
                    <div class="col-auto">
                        <button-build-segment itemId="dysonT3" count="250" btnText="button-buildSegmentSphere" />
                    </div>
                </card-building>
            </page-pane>
            
            <page-pane id="darkmatterPane" name="sidebar-item-darkMatter" icon="\icons\darkmatter.png">
                <card id="darkmatterCard" name="darkmatter">
                    <template v-slot:header>
                        <div class="col-auto">
                            <small class="opacity-50 me-1">x</small>
                            <span :class="{ 'text-light':darkmatter > 0 }"><format-number :value="darkmatter" /></span>
                        </div>
                    </template>
                    <template v-slot:col-1>
                    ...
                    <template v-slot:col-2>
                            ...
                            <div class="row row-cols-1 g-1">
                                ...
                                <div class="col">
                                    <div class="row g-1">
                                        ...
                                        <div class="col-auto">
                                            <small :class="{ 'text-light':getDMAchievement > 0 }"><span v-if="getDMAchievement > 0">+</span><format-number :value="getDMAchievement" /></small>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col">
                                    <div class="row g-1">
                                        ...
                                        <div class="col-auto">
                                            <small :class="{ 'text-light':getDMRing > 0 }"><span v-if="getDMRing > 0">+</span><format-number :value="getDMRing" /></small>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col">
                                    <div class="row g-1">
                                        ...
                                        <div class="col-auto">
                                            <small :class="{ 'text-light':getDMSwarm > 0 }"><span v-if="getDMSwarm > 0">+</span><format-number :value="getDMSwarm" /></small>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col">
                                    <div class="row g-1">
                                        ...
                                        <div class="col-auto">
                                            <small :class="{ 'text-light':getDMSphere > 0 }"><span v-if="getDMSphere > 0">+</span><format-number :value="getDMSphere" /></small>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col">
                            <div class="row g-1">
                                ...
                                <div class="col-auto">
                                    <small :class="{ 'text-success':getDMPotential > 0 }"><span v-if="getDMPotential > 0">+</span><format-number :value="getDMPotential" /></small>
                                </div>
                            </div>
                        </div>
                    </template>
            ...
            <page-pane id="dmUpgradesPane" name="sidebar-item-dmUpgrades" icon="\icons\upgrades.png">
            ...
            <page-pane id="dmBoostsPane" name="sidebar-item-dmBoosts" icon="\icons\boosts.png">
                <line-boost-count />
                <card-boost name="energy" icon="\icons\energy.png" itemId="boostEnergy" />
                <card-boost name="plasma" icon="\icons\plasma.png" itemId="boostPlasma" />
                <card-boost name="meteorite" icon="\icons\meteorite.png" itemId="boostMeteorite" />
                <card-boost name="carbon" icon="\icons\carbon.png" itemId="boostCarbon" />
                <card-boost name="science" icon="\icons\science.png" itemId="boostScience" />
                <card-boost name="oil" icon="\icons\oil.png" itemId="boostOil" />
                <card-boost name="fuel" icon="\icons\fuel.png" itemId="boostFuel" />
                <card-boost name="metal" icon="\icons\metal.png" itemId="boostMetal" />
                <card-boost name="gem" icon="\icons\gem.png" itemId="boostGem" />
                <card-boost name="wood" icon="\icons\wood.png" itemId="boostWood" />
                <card-boost name="silicon" icon="\icons\silicon.png" itemId="boostSilicon" />
                <card-boost name="uranium" icon="\icons\uranium.png" itemId="boostUranium" />
                <card-boost name="lava" icon="\icons\lava.png" itemId="boostLava" />
                <card-boost name="lunarite" icon="\icons\lunarite.png" itemId="boostLunarite" />
                <card-boost name="methane" icon="\icons\methane.png" itemId="boostMethane" />
                <card-boost name="titanium" icon="\icons\titanium.png" itemId="boostTitanium" />
                <card-boost name="gold" icon="\icons\gold.png" itemId="boostGold" />
                <card-boost name="silver" icon="\icons\silver.png" itemId="boostSilver" />
                <card-boost name="hydrogen" icon="\icons\hydrogen.png" itemId="boostHydrogen" />
                <card-boost name="helium" icon="\icons\helium.png" itemId="boostHelium" />
                <card-boost name="ice" icon="\icons\ice.png" itemId="boostIce" />
                <card-boost name="antimatter" icon="\icons\antimatter.png" itemId="boostAntimatter" />
            </page-pane>
            
            <page-pane id="ultritePane" name="sidebar-item-ultrite" icon="\icons\ultrite.png">
                <card id="ultriteCard" name="ultrite">
                    <template v-slot:header>
                        <div class="col-auto">
                            <small class="opacity-50 me-1">x</small>
                            <span :class="{ 'text-light':ultrite > 0 }"><format-number :value="ultrite" /></span>
                        </div>
                    </template>
                    <template v-slot:col-1>
                    ...
                    <template v-slot:col-2>
                            ...
                            <div class="row row-cols-1 g-1">
                                ...
                                <div class="col">
                                    <div class="row g-1">
                                        ...
                                        <div class="col-auto">
                                            <small :class="{ 'text-light':getULSphere > 0 }"><span v-if="getULSphere > 0">+</span><format-number :value="getULSphere" /></small>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col">
                                    <div class="row g-1">
                                        ...
                                        <div class="col-auto">
                                            <small :class="{ 'text-light':getULConquest > 0 }"><span v-if="getULConquest > 0">+</span><format-number :value="getULConquest" /></small>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col">
                                    <div class="row g-1">
                                        ...
                                        <div class="col-auto">
                                            <small :class="{ 'text-light':getULStatue > 0 }"><span v-if="getULStatue > 0">+</span><format-number :value="getULStatue" /></small>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col">
                            <div class="row g-1">
                                ...
                                <div class="col-auto">
                                    <small :class="{ 'text-success':getULPotential > 0 }"><span v-if="getULPotential > 0">+</span><format-number :value="getULPotential" /></small>
                                </div>
                            </div>
                        </div>
                    </template>
            ...
            <page-pane id="ulUpgradesPane" name="sidebar-item-ulUpgrades" icon="\icons\upgrades.png">
                ...
                <card-building id="ulUpgdAutoDysonCard" name="ulUpgdAutoDyson" :descs="[ 'ulUpgdAutoDyson-desc1' ]" itemId="ulUpgdAutoDyson" btnText="button-activate" />
            ...
            <page-pane id="titansPane" name="sidebar-item-titans" icon="\icons\titans.png">
                ...
                <card-titan name="meteorite" icon="\icons\meteorite.png" itemId="titanMeteorite" />
                <card-titan name="carbon" icon="\icons\carbon.png" itemId="titanCarbon" />
                <card-titan name="science" icon="\icons\science.png" itemId="titanScience" />
                <card-titan name="oil" icon="\icons\oil.png" itemId="titanOil" />
                <card-titan name="fuel" icon="\icons\fuel.png" itemId="titanFuel" />
                <card-titan name="metal" icon="\icons\metal.png" itemId="titanMetal" />
                <card-titan name="gem" icon="\icons\gem.png" itemId="titanGem" />
                <card-titan name="wood" icon="\icons\wood.png" itemId="titanWood" />
                <card-titan name="silicon" icon="\icons\silicon.png" itemId="titanSilicon" />
                <card-titan name="uranium" icon="\icons\uranium.png" itemId="titanUranium" />
                <card-titan name="lava" icon="\icons\lava.png" itemId="titanLava" />
                <card-titan name="lunarite" icon="\icons\lunarite.png" itemId="titanLunarite" />
                <card-titan name="methane" icon="\icons\methane.png" itemId="titanMethane" />
                <card-titan name="titanium" icon="\icons\titanium.png" itemId="titanTitanium" />
                <card-titan name="gold" icon="\icons\gold.png" itemId="titanGold" />
                <card-titan name="silver" icon="\icons\silver.png" itemId="titanSilver" />
                <card-titan name="hydrogen" icon="\icons\hydrogen.png" itemId="titanHydrogen" />
                <card-titan name="helium" icon="\icons\helium.png" itemId="titanHelium" />
                <card-titan name="ice" icon="\icons\ice.png" itemId="titanIce" />
                <card-titan name="antimatter" icon="\icons\antimatter.png" itemId="titanAntimatter" />
            </page-pane>
